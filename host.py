...
class MainHost(QWidget):
    ...
    def initUI(self):
        ...
        for i in Hosts.select().where(Hosts.owner == self.s_number):
            if j%2 == 0:
                host = ListHost('1', self.w)
            else:
                host = ListHost('0', self.w)
            host.move(-300, -300)
    ...
    def update_window(self):
        ...
        self.main = CreateHost(self.institution_name)
        self.close()
        self.screen.close()
    def update_(self):
        pass
    ...
    def addCity(self):
        ...
        self.add = CreateHost(self.institution_name)
